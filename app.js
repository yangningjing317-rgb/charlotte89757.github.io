...
function intro(n) {
  return [
    ...
    "These cards turn uncertainty into variables. Your task is to read the signals and design a STEM-informed response. In this stage, STEM is not just background knowledge; it is the compass that helps you interpret technological change, measure real-world problems, and design a wiser response to the waves ahead.",
